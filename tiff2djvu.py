#! /usr/bin/env python
#
# tiff2djvu - A software to merge multiple tiff images to a single djvu file
#       
# Copyright (c) 2012
...
class Base:
	...
	def convert(self,widget):
		...
		cmnd2="pdftk tmp/*.pdf cat output tmp/self.out2_file_merged.pdf"		
		...
		cmnd3="pdf2djvu -o "+self.outputfilename+".djvu tmp/self.out2_file_merged.pdf"		
